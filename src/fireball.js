class Fireball extends InanimateEntity {
  ...
  static gameAreaHeight = Math.trunc(InanimateEntity.parentElement.getBoundingClientRect().height);
  ...
  getRandomYPosition(){
    ...
    const randomYPosition = Math.floor(Math.random() * (Fireball.gameAreaHeight - elementHeight));
